...
In Lab 6, students were to study the Lesson 6 repository, intall Node.js, and run a series of commands.  After refresshing the webpage, students are able to see changes in server activity.  Additionally, sutdents will install Pystache and run several commands.
